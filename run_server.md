...
## Current args
```
Expert streaming and the RAM-miss path
- SGLANG_DSV41_EXPERT_STREAM=1
- SGLANG_DSV41_EXPERT_DIR=/mnt/nvme2/DeepSeek-V4.1-Flash-EXL3-3.0bpw
...
Pinned host tier
- SGLANG_MOE_PINNED_HOST_MB=102400 (100 GiB)
- SGLANG_MOE_PINNED_HOST_NUMA_MB=0:61440,1:40960
...
- SGLANG_DSV41_ENGRAM_TABLE_DIR=/mnt/nvme2/DeepSeek-V4.1-Flash
