...
class Envs:
    ...
    # each decode layer's RAM-resident rows into their VRAM slots with the DMA engine (cudaMemcpyAsync on its own thread)
    # instead of the in-graph SM copy C1, and the graph waits for its completion word. Needs piece streaming. Captured decode
