...
**Files and hashes (v3: SMT-corrected plus the lane guard of item 7; 22 CPU tests pass on them; `quiet_check.py` and `test_c_harness.py` supersede the v2 hashes `…` recorded in commit `a6e410bbbe`):** 
