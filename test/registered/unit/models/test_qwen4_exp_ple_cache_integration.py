...
class TestQwen4ExpPleCacheIntegration(CustomTestCase):
    ...
    def test_cold_cache_completion_starts_trimmer_after_exact_shards(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            embedding = Qwen4ExpPinnedHostEmbedding.__new__(
            ...
            self.assertTrue(os.path.exists(f"{embedding._ple_file_cache.path}.manifest.json"))
