...
- **Code (preview):** `cc/doorbell-serving` `56a5920489`, from `shared/codex/nvfp4-expert-stream-main` plus the copier from `cc/doorbell-prototype` `696b8cc96b`.
